...
@pytest.mark.asyncio
@pytest.mark.parametrize("case", ["unknown_username", "inactive_account", "no_password"])
async def test_failed_logins_always_cost_exactly_one_password_check(monkeypatch: pytest.MonkeyPatch, case: str) -> None:
    ...
    username = {"unknown_username": "nobody", "inactive_account": "ghost", "no_password": "sso-only"}[case]
