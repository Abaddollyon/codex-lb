...
- Code: `app/db/alembic/versions/20260909_040000_add_request_logs_live_facet_indexes.py` (new), `app/db/models.py`, `app/db/migrate.py`, migration and options tests, `Makefile` (PostgreSQL test target list).
